...
# from src.gresource.init_gresource import compile_gresource_for_bundle
#
#
...
#     if "IS_DEV = True" in init_gresource_content:
#         print("Changing IS_DEV to False...")
#         revert_on_finish = True
#         init_gresource_content.replace("IS_DEV = True", "IS_DEV = False")
#         with open(init_gresource_py, "w") as f:
#             f.write(init_gresource_content)
#
#     # BUNDLE APP WITH PYINSTALLER
#     print("Bundling with PyInstaller...")
#
#     if revert_on_finish:
#         print("Reverting IS_DEV to True...")
#         with open(init_gresource_py, "r") as f:
#             init_gresource_content = f.read()
#         init_gresource_content.replace("IS_DEV = False", "IS_DEV = True")
#         with open(init_gresource_py, "w") as f:
#             f.write(init_gresource_content)
#
#     if platform == "linux":
