...
tmux new-window -t $BASENAME -n $WIN_JUPYTER
tmux send-keys -t $BASENAME:$WIN_JUPYTER "jupyter lab --notebook-dir=\"${HOME}\" \"${DIRNAME}/_misc/GTK-ADW-widget-explore.ipynb\"" # C-m
