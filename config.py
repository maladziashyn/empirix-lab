...
# # Logging
# logging.basicConfig(
#     filename=join(src_home, "empirix_lab.log"),
...
SPECS_DIR = "spec"
DEFAULT_VARS_JSON = join(PROJECT_HOME_DIR, SPECS_DIR, "default_variables.json")
DEFAULT_WORK_DIR = join(expanduser("~"), "Documents", APP_NAME)
DEFAULT_SANITY_CHECKS_DIR = "sanity_check"
DEFAULT_SQLITE_DB_DIR = "my_db"
DEFAULT_SQLITE_DB_NAME = "my.db"
DEFAULT_LOG_DIR = "log"

# Specs
SPECS_TBL_DB = join(PROJECT_HOME_DIR, SPECS_DIR, "db_tables.json")
